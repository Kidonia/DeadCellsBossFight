...
public class RollBProj : DC_WeaponAnimation
{
    public override string AnimName => "rolling";
    private Dictionary<int, DCAnimPic> WeaponDic = new();
    public override int TotalFrame => WeaponDic.Count;
    public override void SetDefaults()
    {
        WeaponDic = AssetsLoader.BHanimAtlas[AnimName];
        QuickSetDefault(2, 2, 0, DamageClass.Default, 0, slowBeginFrame: 12);
    }
    ...
    public override void PostDraw(Color lightColor)
    {
        ...
        Vector2 vector = new Vector2(WeaponDic[Projectile.frame].originalWidth / 2 * Projectile.direction //参考解包图片如果在大图里是如何绘制的
            ...
            //位置要修改！！！！
            + new Vector2(Projectile.direction, -34);
...
+ new Vector2(Projectile.direction * 6, -22);
  ...
  0f);
    ...
    {
        Projectile.NewProjectile(Projectile.GetSource_FromAI(), npc.Center, npc.velocity, ModContent.ProjectileType<RollCProj>(), 0, 0, -1, Projectile.ai[0]);
        return true;
    }
}
