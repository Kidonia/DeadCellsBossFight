...
public class BleedCritAtkC : DC_WeaponAnimation
{
    ...
    public override void SetDefaults()
    {
        ...
        QuickSetDefault(72, 74, 18, DamageClass.Default, 0.16f, slowBeginFrame: 5, slowEndFrame: 5);
    }
    ...
    {
        DrawWeaponTexture(WeaponDic, 8, -28, true, new(255, 77, 84));
        DrawfxTexture(fxDic, 12, -28, true, new(41, 0, 0));
    }
