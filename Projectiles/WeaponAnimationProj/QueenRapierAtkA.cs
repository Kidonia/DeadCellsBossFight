...
public class QueenRapierAtkA : DC_WeaponAnimation
{
    ...
    public override void AI()
    {
        ...
        {  
            Projectile.NewProjectile(spawner.GetSource_FromAI(), spawner.Center + new Vector2(Projectile.velocity.X * 130, 40), Projectile.velocity, ModContent.ProjectileType<QueenRapierCut>(), 0, 0, player.whoAmI, MathHelper.ToRadians(Projectile.direction * 22.5f));  
        }
    }
